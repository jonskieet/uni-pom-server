...
import { authMiddleware, adminOrSaleAdmin, adminOrSales } from '../middleware/auth'
...
router.delete('/:id', adminOrSaleAdmin, deleteCategory)   // admin + sales_admin được xóa danh mục
