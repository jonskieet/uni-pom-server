// src/App.tsx — Đã thêm module Hãng sản xuất + Bảng giá + Form Builder
...
const SolutionsPage    = lazy(() => import('./pages/solutions/SolutionsPage'))    // ← MỚI
const FormBuilderPage  = lazy(() => import('./pages/solutions/FormBuilderPage'))  // ← MỚI
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      {/* ← ĐÃ THAY PLACEHOLDER /lead-solutions bằng SolutionsPage + FormBuilderPage */}
      <Route path="/lead-solutions"
        element={<Wrap title="Giải pháp" subtitle="Quản lý & thiết kế form" roles={['admin','technical_lead']}>
          <SolutionsPage />
        </Wrap>} />

      <Route path="/lead-solutions/form-builder/:solutionId"
        element={<Wrap title="Form Builder" subtitle="Thiết kế form khảo sát" roles={['admin','technical_lead']}>
          <FormBuilderPage />
        </Wrap>} />
