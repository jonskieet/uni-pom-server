...
export const FormTemplateService = {
  getAll:  (solution_id?: number) => window.api.formTemplates.getAll(solution_id),
  getById: (id: number)            => window.api.formTemplates.getById(id),
  create:  (data: any)             => ipc(window.api.formTemplates.create(data)),
  update:  (id: number, data: any) => ipc(window.api.formTemplates.update(id, data)),
  delete:  (id: number)            => ipc(window.api.formTemplates.delete(id)),
}
